...
public class HomeFragNew extends Fragment implements View.OnClickListener {
    ...
    LinearLayout sports_lld, sports_sublld, sports_subleaguell;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fragonenew, container, false);
...
//        timer.scheduleAtFixedRate(new MytimerTask(), 6000, 5000);
    ...
    List<String> subLeg = new ArrayList<>();
    List<String> sports_leg = new ArrayList<>();

    List<String> sports_stage3 = new ArrayList<>();

    //Dyminc data
    private void getSportsLegs() {
        AndroidNetworking.get(APIs.SPORTS)
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                JSONObject bb = response.getJSONObject(i);
                                sports_leg.add(bb.getString("name"));
                                Button txt_level1 = new Button(getActivity());
                                txt_level1.setId(i+1);
//                                txt_level1.setId(bb.getInt("sportId"));
    ...
    //                                txt_level1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_basketball, 0, 5, 0);
                            ...
                            //    txt_level1.setLayoutParams(layoutParams);
                                txt_level1.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {

                                        txt_level1.setBackgroundResource(R.drawable.edit_border_blue_home);
                                        txt_level1.setTextColor(ResourcesCompat.getColor(getResources(), R.color.white, null));

                                        subLeg.clear();

                                        try {
                                            JSONArray kk = bb.getJSONArray("leagues");

                                            for (int j = 0; j < kk.length(); j++) {
                                                JSONObject subl = kk.getJSONObject(j);
                                                subLeg.add(subl.getString("leagueAbbreviation"));
                                            }

                                            Log.e("410---", subLeg.toString());

                                            if (subLeg.size() > 0) {
                                                sports_sublld.removeAllViews();
                                                sports_subleaguell.removeAllViews();

                                                for (int i = 0; i < subLeg.size(); i++) {

                                                    Button btn1 = new Button(getActivity());
                                                    btn1.setText(subLeg.get(i) + "");
                                                    btn1.setOnClickListener(new View.OnClickListener() {
                                                        @Override
                                                        public void onClick(View view) {
                                                            getcardsFliters(btn1.getText().toString().trim(), txt_level1.getText().toString().trim());
                                                        }


                                                    });
                                                    sports_sublld.addView(btn1);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            try {
                                ...
                                if (sports.equalsIgnoreCase(jb.getString("sport_name")) &&
                                        league.equalsIgnoreCase(jb.getString("leagueAbbreviation"))) {

                                    sports_stage3.add(jb.getString("cardType"));
                        ...
                        Log.e("548----", sports_stage3.toString());
                        if (sports_stage3.size() > 0) {
                            sports_subleaguell.removeAllViews();
                            for (int k = 0; k < sports_stage3.size(); k++) {

                                Button btn1 = new Button(getActivity());
                                btn1.setText(sports_stage3.get(k) + "");
                                sports_subleaguell.addView(btn1);
                                ...
                                btn1.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        cardsResponse.clear();
                                        recyclerViewItems.clear();
                                        getcardsInfo(sports_stage3.get(finalK), response, sports);
...
//                            if (text.toString().contains(LINK))
    ...
    private void getcardsInfo(String s, JSONArray response, String sports) {
        cardsResponse.clear();
        recyclerViewItems.clear();
...
//            Log.e("ALL +HOME pro:: ", response.toString());
            ...
            for (int i = 0; i < response.length(); i++) {
                ...
                try {
                    ...
                    if (jb.getString("cardType").equalsIgnoreCase(s) && sports.equalsIgnoreCase(jb.getString("sport_name"))) {
...
//            recyclerViewItems.add(cardsResponse);
            recycleAdapter = new RecyclerViewAdapterNew(recyclerViewItems, getActivity());
            rvHomeCards.setAdapter(recycleAdapter);
...
//        playVideo("", "https://www.youtube.com/watch?v=dZVcznuYd6Y", "dd","dd", true);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        sports_lld = getActivity().findViewById(R.id.sports_lld);
        sports_sublld = getActivity().findViewById(R.id.sports_sublld);
        sports_subleaguell = getActivity().findViewById(R.id.sports_subleaguell);
...
//            }
            ...
            switch (viewType) {
                case MENU_ITEM_VIEW_TYPE:
                    ...
                    String cardType_new = all_home_cards.getCardType();
                    listingView.tvMatchUpType.setText(cardType_new);
